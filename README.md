...
-   Add a synopsis to `Functional-Music.cabal`. It should be a short (one sentence)
    explanation of your project.

-   Add a category to `Functional-Music.cabal`. A list of categories is available on
...
[Functional-Music]: https://github.com/lokilow/Functional-Music
